...
let map = {
    ...
    // MOVE1_ID: { address: 0x58, bits: 0x2 },
    // MOVE2_ID: { address: 0x5C, bits: 0x2 },
    // MOVE3_ID: { address: 0x5E, bits: 0x2 },
    // MOVE4_ID: { address: 0x60, bits: 0x2 },
    // MOVE1_PP: { address: 0x62, bits: 0x1 },
    // MOVE2_PP: { address: 0x63, bits: 0x1 },
    // MOVE3_PP: { address: 0x64, bits: 0x1 },
    // MOVE4_PP: { address: 0x65, bits: 0x1 },
    // MOVE1_PPUPS: { address: 0x66, bits: 0x1 },
    // MOVE2_PPUPS: { address: 0x67, bits: 0x1 },
    // MOVE3_PPUPS: { address: 0x68, bits: 0x1 },
    // MOVE4_PPUPS: { address: 0x69, bits: 0x1 },
    // MOVE1_RELEARN: { address: 0x6A, bits: 0x2 },
    // MOVE2_RELEARN: { address: 0x6C, bits: 0x2 },
    // MOVE3_RELEARN: { address: 0x6E, bits: 0x2 },
    // MOVE4_RELEARN: { address: 0x70, bits: 0x2 },
